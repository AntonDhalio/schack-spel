...
const Board = () => {
  ...
  /* function selectPiece(e) {
    ...
    else if (activePiece != null && tile.className.includes('Square')) {
      console.log(e.target);
      let newTile = e.target;
      newTile.style.visibility = 'visible';
      console.log(activePiece.src);
    }
  }  */
  ...
  return (
    <div className="board" onClick={handleSquareClick} >{board}</div>
  )
}
